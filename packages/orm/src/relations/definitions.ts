...
export type SchemaLike = import('../schema/schema.js').Schema<any, any, any, any, any>;
...
> {
  ...
  /** Relation map of the target, carried separately to avoid recursively wrapping its schema type. */
